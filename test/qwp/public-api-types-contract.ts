/**
 * Exhaustive source-level contract for erased public names.
 *
 * Runtime export enumeration cannot see TypeScript-only symbols. Keep these
 * lists explicit so removing a barrel re-export fails typecheck:test, and so
 * every addition is reviewed as a deliberate public API change.
 */
export type {
  ExtraOptions,
  Logger,
...
// Import the shared names independently through the browser root. Aliases keep
